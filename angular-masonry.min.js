!function(n,r){"use strict";"function"==typeof define&&define.amd?define(["angular","Masonry"],r):"object"==typeof exports?module.exports=r(angular,Masonry):n.ngMasonry=r(angular,Masonry)}(this,function(n,r){"use strict";n.module("ngMasonry",[]).controller("masonryController",function(){function t(){return!!i.config&&!!i.config.masonryContainer}function o(){var t={itemSelector:"["+i.config.masonryItem+"]"},o=i.config.masonryOption?n.extend(t,i.config.masonryOption):t;i.container=new r("["+i.config.masonryContainer+"]",o)}function e(){i.container.layout()}var i=this;i.config={},i.ready=t,i.initialize=o,i.reLayout=e}).directive("masonry",function(){function n(n){var r=n.children();if(r.length>=1&&void 0!==r.attr("data-masonry-item")){var t=r.attr("data-masonry-after-render","");r.remove(),n.append(t)}return{post:function(n,r,t,o){o.config.masonryContainer=t.$attr.masonry,o.config.masonryOption=JSON.parse(t.masonryOptions||"{}")}}}var r={restrict:"A",controller:"masonryController",compile:n};return r}).directive("masonryItem",function(){function n(n,r,t,o){n.$last&&o.ready()&&(o.config.masonryItem=t.$attr.masonryItem,o.initialize())}var r={restrict:"A",require:"^masonry",priority:1,link:n};return r}).directive("masonryAfterRender",["$timeout",function(n){function r(r,t,o,e){if(r.$last){var i=null;i=n(function(){e.reLayout(),n.cancel(i)})}}var t={restrict:"A",require:"^masonry",priority:0,link:r};return t}])});
